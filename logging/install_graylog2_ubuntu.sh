...
echo  "LoadModule passenger_module /usr/local/rvm/gems/ruby-1.9.3-p448/gems/passenger-3.0.19/ext/apache2/mod_passenger.so" | sudo tee -a /etc/apache2/mods-available/passenger.load
echo "PassengerRoot /usr/local/rvm/gems/ruby-1.9.3-p448/gems/passenger-3.0.19" | sudo tee -a /etc/apache2/mods-available/passenger.conf
echo "PassengerRuby /usr/local/rvm/wrappers/ruby-1.9.3-p448/ruby" | sudo tee -a /etc/apache2/mods-available/passenger.conf
